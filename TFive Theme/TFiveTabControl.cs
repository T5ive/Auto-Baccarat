...
//                    try
//                    {
//                        G.DrawString(TabPages[ItemIndex].Text, new Font(Font.Name, Font.Size, Font.Style), new SolidBrush(Color.FromArgb(0, 100, 255)), new Rectangle(GetTabRect(ItemIndex).Location, GetTabRect(ItemIndex).Size), new StringFormat
//                        {
//                            LineAlignment = StringAlignment.Center,
//                            Alignment = StringAlignment.Center
//                        });
